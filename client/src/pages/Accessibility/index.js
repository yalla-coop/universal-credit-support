  ...
  return (
    <Row jc="space-between">
      <Col w={[4, 12, 6]} dir="column" ai="flex-start">
        ...
        <T.P mt="5" mtM="0">
          Whilst we aim to make this website accessible to all users and achieve
          a conformance level ‘AAA’; we continually work with stakeholders to
          ensure that conformance level ‘A’ is adhered to as a minimum.
        </T.P>{' '}
        <C.Tips
          mt="5"
          mtM="4"
